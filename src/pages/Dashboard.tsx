...
const Dashboard: React.FC = () => {
  const { user } = useAuth();
  const { calculations, investmentCalculations, deleteCalculation } = useCalculations();
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">Mortgage Calculations</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900">{investmentCalculations.length}</div>
              <div className="text-sm text-gray-600">Investment Analyses</div>
            </div>
          </div>
        </div>
