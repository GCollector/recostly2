  ...
  return (
    <div className="flex gap-3">
      <button
        onClick={onSave}
        disabled={isSaving}
        className="flex items-center justify-center px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors disabled:opacity-50"
      >
